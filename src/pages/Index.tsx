    ...
    <div ref={ref} className="min-h-screen flex flex-col">
      ...
      <section className="gradient-hero relative overflow-hidden flex-1 flex items-center justify-center px-4 py-16 min-h-[70vh]">
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto">
          <div className="inline-flex items-center justify-center <div className="inline-flex items-center justify-center w-56 h-56 mb-6 animate-float rounded-full overflow-hidden bg-white/20 backdrop-blur-sm"> mb-6 animate-float rounded-full overflow-hidden bg-white/20 backdrop-blur-sm">
