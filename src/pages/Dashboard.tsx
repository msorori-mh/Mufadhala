...
import {
  ...
  Building2, ChevronLeft, Lightbulb, RefreshCw, FileText, Flame,
} from "lucide-react";
...
const Dashboard = () => {
  ...
  const navCards = [
    ...
    { path: "/past-exams", title: "نماذج الأعوام السابقة", desc: "اختبر نفسك بنماذج مفاضلات السنوات الماضية", icon: FileText, color: "border-r-primary", iconColor: "text-primary", bgColor: "bg-primary/10" },
    { path: "/top-questions", title: "أهم الأسئلة في المفاضلات", desc: "أسئلة تكررت في اختبارات سابقة — ركّز عليها", icon: Flame, color: "border-r-destructive", iconColor: "text-destructive", bgColor: "bg-destructive/10" },
  ...
  return (
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 md:pb-6">
