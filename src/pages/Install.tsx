...
✨ *ماذا ستجد في المنصة؟*
📖 دروس وملخصات شاملة لجميع المواد
📝 نماذج الاختبارات السابقة الحقيقية للجامعات اليمنية
🔁 الأسئلة الأكثر تكراراً عبر السنوات
🤖 مولّد أسئلة ذكي بالذكاء الاصطناعي (مُفَاضِل AI)
🎯 محاكي اختبار حقيقي (50 سؤال / 50 دقيقة)
📊 تحليل أدائك ونقاط قوتك وضعفك
🏆 لوحة المتصدرين وتحديات يومية
🏫 دليل الكليات وشروط القبول
💬 مساعد ذكي للإجابة على أسئلتك

🎁 *مجاني بالكامل* — سجّل وابدأ فوراً
  ...
  return (
    <>
      ...
      <div className="container max-w-2xl mx-auto px-4 py-3 space-y-3">
        ...
        {/* 1) PLATFORM FEATURES — shared with PDF brochure (single source of truth) */}
